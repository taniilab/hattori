...
class Neuron:
    def __init__(self, sim_time_ms=180000, dt_ms=0.04):
        ...
        self.cell_left = HH_compartment(sim_time_ms=sim_time_ms,
                                        dt_ms=dt_ms,
                                        stim_timing_ms=[1000, 1001],  # [1000, 1020, 1040],
                                        stim_ext_potential=[-0.1, 0])  # [0.1, -0.1, 0])
...
def main():
    ...
    df_left.to_csv('C:/Users/Tanii_Lab/Downloads/cell_left.csv')
    df_right.to_csv('C:/Users/Tanii_Lab/Downloads/cell_right.csv')
