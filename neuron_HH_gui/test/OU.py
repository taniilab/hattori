...
plt.plot(t, noise3, label="É∆:0.5  É :0   D:6")
plt.plot(t, noise2, label="É∆:0.5  É :0   D:3")
plt.plot(t, noise1, label="É∆:0.5  É :0   D:1")
plt.plot(t, noise6, label="É∆:0.5  É :10  D:6")
plt.plot(t, noise5, label="É∆:0.5  É :10  D:3")
plt.plot(t, noise4, label="É∆:0.5  É :10  D:1")
