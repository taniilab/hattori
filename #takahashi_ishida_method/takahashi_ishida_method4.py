...
class Ca_analyze:
    ...
    def modify_baseline_window(self, roi_csv_file, dt, window):
        """
    ...
    def write_hist2(self, dt, roi_csv_file, bin, histogram_save_path):
        """
        ...
        mod_mean = self.modify_baseline_window(roi_csv_file, dt, 25)
    ...
    def detect_firing(self, roi_csv_file, dt, result_csv_save_path, window, bin):
        """
        ...
        mod_mean = self.modify_baseline_window(roi_csv_file, dt, window)
    ...
    def all_analysis(self, dt, x, y, roi_num, fig_save_path, csv_save_path, window, bin, CellPercent, thres_burst_time):
        ...
        self.write_hist2(dt=dt, roi_csv_file=csv_save_path + '/' + os.path.basename(self.path) + '_roi_data.csv',
                         bin=bin, histogram_save_path=fig_save_path)
...
def main():
    ...
    cxd_data_path = 'C:\Users/admin\Desktop/2019.7.2'
    csv_save_path = 'C:\Users/admin\Desktop/2019.7.2'
    fig_save_path = 'C:\Users/admin\Desktop/2019.7.2'
    ...
    """
    c.analysis_after_output_roi_csv(dt=dt, roi_csv_file='C:/Users/admin/Desktop/190618/190628/Data347_roi_data.csv',
