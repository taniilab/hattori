...
def main():
    ...
    df_left.to_csv(
        'C:/Users/ishida/Desktop/stim_neuron_sim/cell_left_{0}Mohm_{1}_{2}.csv'.format(R,
                                                                                       left_stim_ext_potential[0],
                                                                                       left_stim_ext_potential[1]))
    df_right.to_csv(
        'C:/Users/ishida/Desktop/stim_neuron_sim/cell_right_{0}Mohm_{1}_{2}.csv'.format(R,
                                                                                        left_stim_ext_potential[0],
                                                                                        left_stim_ext_potential[1]))
    ...
    plt.tight_layout()
    plt.savefig(
        'C:/Users/ishida/Desktop/stim_neuron_sim/picture/cell_{0}Mohm_{1}_{2}.png'.format(R,
                                                                                          left_stim_ext_potential[0],
                                                                                          left_stim_ext_potential[1]),
        dpi=600)
    plt.show()
