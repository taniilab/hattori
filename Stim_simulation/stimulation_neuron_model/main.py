...
def main():
    ...
    df_left.to_csv('I:/Box Sync/Personal/Simulation Data/202001/cell_left_{0}_{1}.csv'.format(left_stim_ext_potential[0],
                                                                                          left_stim_ext_potential[1]))
    df_right.to_csv('I:/Box Sync/Personal/Simulation Data/202001/cell_right_{0}_{1}.csv'.format(left_stim_ext_potential[0],
                                                                                            left_stim_ext_potential[1]))
